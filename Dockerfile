...
RUN wget https://github.com/coin-or/Ipopt/archive/refs/tags/releases/3.14.19.zip && \
     unzip Ipopt-3.14.19.zip && \
     rm Ipopt-3.14.19.zip
RUN sh install_ipopt.sh Ipopt-3.14.19  
